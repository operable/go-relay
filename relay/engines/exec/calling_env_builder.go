...
// BuildCallingEnvironment constructs the calling environment for a command
func BuildCallingEnvironment(request *messages.ExecutionRequest, relayConfig *config.Config) []string {
